  ...
  return (
    <>
      <div className="bg-black h-dvh text-white">
        <main className="flex flex-col max-h-screen max-w-screen p-2">
          <Header />
          <div className="flex justify-between overflow-auto">
            ...
            <NowPlaying>
              ...
              <div className="bg-22 rounded-lg mt-6">
                ...
                <ul className="flex px-4 space-x-4 overflow-x-auto h-[158px]">
                  {musicas.slice(0, 1).map((musica) =>
              ...
              {musicas.slice(1, 2).map((aSeguir) => (
                <div className="bg-22 rounded-lg p-4 mb-4">
                  ...
                  <div className="flex items-center space-x-3">
                    <img src={aSeguir.capa} className="h-12 rounded" />
