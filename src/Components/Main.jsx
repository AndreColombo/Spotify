    ...
    <>
      <main className="w-main bg-gradient-to-b from-[#211260] via-12 to-12 rounded-lg overflow-y-scroll px-6 py-4">
        ...
        <div className="grid grid-cols-4 space-x-2 space-y-2">
          <div className="flex items-center rounded bg-white bg-opacity-10">
          ...
          <div className="flex items-center rounded bg-white bg-opacity-10">
            <img src="/Playlists/BigRoomDance.png" className="rounded-l h-12" />
            <h1 className="text-sm font-bold line-clamp-2 m-2">
              Big Room Dance
            </h1>
          </div>
          ...
          <div className="flex items-center rounded bg-white bg-opacity-10">
            <img src="/Playlists/ChaseTheSun.png" className="rounded-l h-12" />
            <h1 className="text-sm font-bold line-clamp-2 m-2">
              Chase The Sun
            </h1>
          </div>
